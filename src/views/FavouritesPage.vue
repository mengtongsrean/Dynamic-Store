<template>
  <div class="container my-5">
    ...
    <div v-if="!isAuthenticated" class="text-center">
      <p>
        You need to <router-link to="/login-page">login</router-link> or
        <router-link to="/register-page">register</router-link> to view your
        favourite items.
      </p>
    </div>
    <div v-else>
      ...
      <div v-else>
        ...
        <div class="text-center mt-4">
          <button
            ...
            v-if="displayedItems.length < favoriteItems.length"
            @click="loadMore"
          >
            Load More
          </button>
    ...
    async removeFromFavorites(productId) {
      try {
        await axiosInstance.delete(
          `/users/remove-favourite-item/${productId}`,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
