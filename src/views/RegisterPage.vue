    ...
    methods: {
        ...
        validateForm() {
            ...
            if (!this.username || !this.username.match(namePattern)) {
                this.errors.username = "Username must contain only letters and is required.";
            }
            // Validate email
            ...
            if (!this.password || !this.validatePassword(this.password)) {
                this.errors.password = "Password must be at least 8 characters and include at least one special character ($, %, ^, &, *).";
            }
            ...
            if (!this.phone || !this.validatePhone(this.phone)) {
                this.errors.phone = "Mobile number must be 10 digits and start with 04.";
            }
